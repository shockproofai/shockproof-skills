...
5. **Respect Timing**: Aim for narration that takes 30-60 seconds per slide — 30 seconds is the minimum for any content slide. For complex slides, extend to 90 seconds maximum. Title slides can be 15-20 seconds.
...
10. **Introduce Lists and Card Sets with Context First**: When a slide contains a bullet list, a numbered step sequence, or a set of cards each with bullet details, the narration MUST open by explaining WHY this information matters — what the learner will use it for, why it's relevant at this point in the course, or what problem it solves. Do NOT open by enumerating items or announcing how many there are. After framing the importance, you may address individual items — but paraphrase and explain each one rather than reading the slide text verbatim.

    ❌ Avoid opening with: "There are five steps here. Step one is Employment and Economy. Step two is Supply Pipeline..."
    ✅ Do this instead: "Before you walk into a borrower interview, you need to have done your market homework. These five areas form your baseline — miss any one of them and you'll be caught off guard when the borrower starts citing data you haven't seen. Start with employment and economic drivers, then look at the supply pipeline..."
